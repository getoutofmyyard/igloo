...
def update_windows():
    ...
    or 'AllSigned' in execution_policy:
        ...
        unblock = pshell_decoder('Unblock-File -Path \'C:\\Program Files (x86)\\igloo\\scripts\\updateWindows.ps1\' | Out-Null')
        ...
        subprocess.call(['powershell.exe', 'Set-Location -Path \"C:\\Program Files (x86)\" | powershell .\\igloo\\scripts\\updateWindows.ps1'])
        subprocess.call(['powershell.exe','Set-Location -Path ' + split_it[1]] + ' | Out-Null')
